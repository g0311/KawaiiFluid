...
IMPLEMENT_GLOBAL_SHADER(FApplyViscosityAndCohesionCS,
	"/Plugin/KawaiiFluidSystem/Private/FluidApplyViscosityAndCohesion.usf",
	"ApplyViscosityAndCohesionCS", SF_Compute);
